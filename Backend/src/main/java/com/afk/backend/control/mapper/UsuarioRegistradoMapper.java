...
@Mapper(componentModel = "spring",
        uses = { UbicacionMapper.class, RolMapper.class})
public interface UsuarioRegistradoMapper {
    ...
    @Mapping(target = "estado_usuario_registrado", source = "estadoNombre")
    ...
    @Mapping(target = "estadoNombre", source = "estado_usuario_registrado")
    @Mapping(target = "nombre", source = "nombre")
